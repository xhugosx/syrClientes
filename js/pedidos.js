...
function setBuscarPedidosSearch(busqueda) {
    ...
    servidor('https://empaquessyrgdl.000webhostapp.com/empaquesSyR/lista_pedidos/selectAll.php?type=2&cliente=' + id+'&search='+busqueda, getBuscarPedidos);
}
...
function setBuscarPedidos() {
    ...
    servidor('https://empaquessyrgdl.000webhostapp.com/empaquesSyR/lista_pedidos/selectAll.php?type=2&cliente=' + id, getBuscarPedidos);
}
